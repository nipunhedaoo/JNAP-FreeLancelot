...
public class FreeLancerServicesTest extends WithApplication {
    ...
    public void testWordStatsIndevidual(){
        ...
        actorSystem = ActorSystem.create();
        freeLancerServices=new FreeLancerServices(actorSystem,null);
     ...
     */
    @Test
    public void testIndSkills() throws InterruptedException, TimeoutException, IOException {
        ...
        try {
            FreeLancerServices freeLancerServices1 = new FreeLancerServices(actorSystem,materializer);
            List<ProjectDetails>list= freeLancerServices1.searchSkillProjectsJson(jsonNode);
            Object projectDetails=freeLancerServices1.searchResults("react");
     ...
     */
    @Test
    public void getNumOfWords() throws JSONException {
        String projectDescription = "The Australian platypus is seemingly a hybrid of a mammal and reptilian creature.";
        FreeLancerServices freeLancerServicesObj = new FreeLancerServices(actorSystem,materializer);
    ...
    @Test
    public void testStuff() throws JSONException {
        ...
        List<ProjectDetails>list= freeLancerServicesObj.searchModelByKeyWord(jsonNode);
    ...
    public void fleschKancidGradeLevvelAverage(){
        ...
        assertEquals(0, Double.compare(freeLancerServicesObj.fleschKancidGradeLevvel(projectDetails), 0.6666666666666666));
        assertNotEquals(0, Double.compare(freeLancerServicesObj.fleschKancidGradeLevvel(projectDetails), 2.0));
        assertNotEquals(1, Double.compare(freeLancerServicesObj.fleschKancidGradeLevvel(projectDetails), 0.6666666666666666));
    ...
    public void fleschReadabilityAverage(){
        ...
        assertEquals(0, Double.compare(freeLancerServicesObj.readabilityIndex(projectDetails), 110.33333333333333));
        assertNotEquals(0, Double.compare(freeLancerServicesObj.readabilityIndex(projectDetails), 90));
        assertNotEquals(1, Double.compare(freeLancerServicesObj.readabilityIndex(projectDetails), 110.33333333333333));
        assertEquals(1, Double.compare(freeLancerServicesObj.readabilityIndex(projectDetails), 90));
    }
