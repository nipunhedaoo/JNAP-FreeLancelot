...
public class FreeLancerServicesTest extends WithApplication {
    ...
    public void testSkills() {
        ...
        running(provideApplication(), () -> {
            ActorRef obj = mock(ActorRef.class);
            CompletableFuture completableFuture=mock(CompletableFuture.class);
            when(freeLancerServices.searchSkillResults("9")).thenReturn(obj);
            CompletionStage<Result> resultCompletionStage=homeController.searchBySkill("9","Java",null);
     ...
     */
    @Test
    public void testIndSkills() throws InterruptedException, TimeoutException {
