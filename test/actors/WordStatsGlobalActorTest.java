...
public class WordStatsGlobalActorTest {
        ...
        new TestKit(actorSystem) {
            {
                ...
                Props props = Props.create(WordStatsGlobalActor.class);
                Object results = new Object();
                TestActorRef<WordStatsGlobalActor> ref = TestActorRef.create(actorSystem, props);
