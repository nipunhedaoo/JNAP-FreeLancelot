...
public class FreeLancerServices implements WSBodyReadables, WSBodyWritables {
    ...
    /**
     * <p>This function processes the API call response and fetches the project list associated with the keyword.</p>
     *
     * @param res It represents the WSResponse of API call made for the search keyword
